...
import com.liansen.flow.rest.model.ModelsPaginateList;
...
public class ModelResource extends BaseModelResource {
    ...
    public PageResponse getModels(@ApiIgnore @RequestParam Map<String, String> requestParams) {
