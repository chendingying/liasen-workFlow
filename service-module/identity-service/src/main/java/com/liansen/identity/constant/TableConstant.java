package com.liansen.identity.constant;
...
public class TableConstant {
    ...
    public static final int MODULE_TYPE_PARNET_ID = 0;
    public static final byte MODULE_TYPE_STATUS_NORMAL = 0;
    public static final byte MODULE_TYPE_STATUS_STOP = 1;
}
